...
import com.AbdUlla.a4_order_station_driver.models.PhotoObject;
...
//    Call<VerifyCode> verifyCode(@Body ResetCode resetCode);
    ...
    Call<Result<ArrayList<Notification>>> getNotifications();

    //orders
    @GET("driver/orders")
    Call<Result<Orders>> getOrders();

    //4OrderStation
    @GET("driver/orders/details/{id}")
    Call<Result<OrderStation>> getOrderStation(@Path("id") int id);
...
*/
    ...
    Call<Result<PublicOrder>> getPublicOrder(@Path("id") int id);
