package com.AbdUlla.a4_order_station_driver.feature.reset;

import android.os.Bundle;

import com.AbdUlla.a4_order_station_driver.R;
import com.AbdUlla.a4_order_station_driver.databinding.ActivityResetPasswordBinding;
...
import com.AbdUlla.a4_order_station_driver.feature.reset.one.ResetStep1;
import com.AbdUlla.a4_order_station_driver.feature.reset.three.ResetStep3;
import com.AbdUlla.a4_order_station_driver.feature.reset.two.ResetStep2;
    ...
    public void navigate(int page) {
        switch (page) {
            ...
            case ResetStep3.page:
                resetStep3 = ResetStep3.newInstance(this,resetStep1.getMobile());
                new NavigateUtil().replaceFragment(getSupportFragmentManager()
